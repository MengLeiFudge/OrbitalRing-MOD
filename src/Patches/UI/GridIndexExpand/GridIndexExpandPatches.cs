...
namespace ProjectOrbitalRing.Patches.UI
{
    ...
    internal static class GridIndexExpandPatches
    {
        ...
        {
            __instance.windowRect.sizeDelta = new Vector2(742, 811);
            __instance.recipeGroup.sizeDelta = new Vector2(644, 322);
            __instance.queueGroup.GetComponentInChildren<RectTransform>().sizeDelta = new Vector2(644f, 46f);
        ...
        public static void UIGame_OnInit_Postfix(UIGame __instance)
        {
            ...
            __instance.recipePicker.pickerTrans.sizeDelta = new Vector2(692, 476);
            __instance.itemPicker.pickerTrans.sizeDelta = new Vector2(692, 476);
            __instance.signalPicker.pickerTrans.sizeDelta = new Vector2(692, 476);
            __instance.lootFilter.filterTrans.sizeDelta = new Vector2(692, 476);
        }
        ...
        public static void UIRecipePicker_OnOpen_Postfix(ManualBehaviour __instance) =>
            __instance.transform.Find("content").GetComponent<RectTransform>().sizeDelta = new Vector2(644, 322);
